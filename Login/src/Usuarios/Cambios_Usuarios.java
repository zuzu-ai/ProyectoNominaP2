 ...
 * @author kievk
 */
public class Cambios_Usuarios extends javax.swing.JFrame {

    /**
     * Creates new form Cambios_Usuarios
     */
    public Cambios_Usuarios() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cambios_Usuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cambios_Usuarios().setVisible(true);
            }
        });
    }
